...
use ClouSale\AmazonSellingPartnerAPI\Lib\GuzzleHttp\Psr7\Query;
...
//        ]
        ...
        try {
            ...
            $credentials = $json['AssumeRoleResponse']['AssumeRoleResult']['Credentials'] ? $json['AssumeRoleResponse']['AssumeRoleResult']['Credentials'] : null;
//            $tokens = [
